#' example code for parsing doc comments in getTypeinfo
#' @param x matrix
#' @param k numeric(1) maximum number of potential outliers to be considered
#' @param Ci function to evaluate covariance of columns of input matrix
#' @param lamfun function that defines critical thresholds 
#' @param alpha overall significance level of detection procedure
#' @param method character(1)
#' @param \dots unused
#' @return list
#' @note Thompson,W. R. (1935), "On a Criterion for the Rejection of Observations and 
#' the Distribution of the Ratio of Deviation to Sample Standard Deviation,The Annals 
#' of Mathematical Statistics,6, 214-219, provides theory for choice of lamfun
#' @export
mv.calout.detect <-
...
#' calibrated univariate outlier detection
#' @param x numeric() vector
#' @param alpha numeric(1) overall significance level of multiple outlier detection
#' @param method character(1)
#' @param k numeric(1) maximum number of outliers to be considered
#' @param location function to estimate location parameter
#' @param scale function to estimate scale parameter
#' @param gen.region function to create inlier region
#' @return list
#' @export
